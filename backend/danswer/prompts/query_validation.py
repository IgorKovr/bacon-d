...
{QUESTION_PAT.upper()} Bacon is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Bacon being unreachable. \
Assuming the documents from search contains situations where Bacon is not reachable and \
