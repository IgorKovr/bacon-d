...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to Bacon. Once setup, you will be able
        to ask questions to Bacon directly from Slack. Additionally, you can:
      </Text>

      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup BaconBot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets BaconBot should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message BaconBot to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      <Text className="mb-6">
        ...
        found in the Bacon documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup BaconBot</Title>
          <Text className="mb-3">
            Configure Bacon to automatically answer questions in Slack
            channels. By default, Bacon only responds in channels where a
