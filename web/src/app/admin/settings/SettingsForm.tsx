      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Bacon to retain chat messages. Leaving this field empty will cause Bacon to never delete chat messages."
