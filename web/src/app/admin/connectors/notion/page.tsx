      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Bacon. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Bacon to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Bacon integration."
                ),
              })}
              initialValues={{
