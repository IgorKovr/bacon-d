  ...
  switch (selectedFlow) {
          ...
          <div className="mt-3">
            ...
            <div>
              <p>
                ...
                automatically sync data from your apps and docs into Bacon, so
    ...
    case "chat":
      ...
      body = (
        <>
          ...
          <div className="mt-3">
            <div>
              To start using Bacon as a secure ChatGPT, we just need to
              configure our LLM!
              <br />
              <br />
              Bacon supports connections with a wide range of LLMs, including
    ...
    default:
      ...
      body = (
        <>
          <div>
            <p>How are you planning on using Bacon?</p>
          </div>
          <Divider />
          <UsageTypeSection
